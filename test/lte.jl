@testset "lte.jl" verbose=true begin
    ...
    # Limits:
    @test all(saha_boltzmann(H_empty, 1e2, 1e15, 1.0) .== [1.0, 0, 0, 0])
    @test all(isapprox.(saha_boltzmann(H_empty, 1e20, 1e15, 1.), [0, 0, 0, 1.0], atol=1e-20))
